...
import com.sitewhere.device.event.processor.*;
...
public class InboundProcessingChainParser {
    ...
    protected Object parse(Element element, ParserContext context) {
        ...
        for (Element child : dsChildren) {
            ...
            switch (type) {
                ...
                case MeasurementsFilterProcessor: {
                    processors.add(parseMeasurementsFilterProcessor(element, context));
                }
                case AlertDataProcessor: {
                    processors.add(parseAlertDataProcessor(element, context));
                }
            }
        }
    ...
    /**
     * Parse configuration for Measurements Filter Processor
     *
     * @param element
     * @param context
     * @return
     * @author Joeg
     */
    protected AbstractBeanDefinition parseMeasurementsFilterProcessor(Element element, ParserContext context) {
        BeanDefinitionBuilder processor =
                BeanDefinitionBuilder.rootBeanDefinition(MeasureFilterProcessor.class);
        return processor.getBeanDefinition();
    }


    /**
     * Parse configuration for Alert Data Processor
     *
     * @param element
     * @param context
     * @return
     * @author Joeg
     */
    protected AbstractBeanDefinition parseAlertDataProcessor(Element element, ParserContext context) {
        BeanDefinitionBuilder processor =
                BeanDefinitionBuilder.rootBeanDefinition(AlertDataProcessor.class);
        return processor.getBeanDefinition();
    }
    ...
    public static enum Elements {
        ...
        /**
         * Measurements Filter  Processor @author Joeg
         */
        MeasurementsFilterProcessor("measurements-filter-processor"),

        /**
         * Alert Data  Processor @author Joeg
         */
        AlertDataProcessor("alert-data-processor");
